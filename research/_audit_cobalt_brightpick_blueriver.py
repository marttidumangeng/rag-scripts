"""Audit Cobalt (213), Brightpick (375), Blue River (423) for next US enrich."""
...
# from prior candidate audit
TARGETS = {
    213: [1659],  # Cobalt Chinese shell?
    375: [5054, 5053],  # Brightpick
    423: [5042, 381, 380],  # Blue River
}
    ...
    for cid, ids in TARGETS.items():
        ...
        for rid in ids:
            try:
                ...
                print("ERR", rid, e)
    oem("https://www.cobaltrobotics.com/")
    oem("https://www.cobaltai.com/")
    oem("https://brightpick.ai/")
    oem("https://brightpick.ai/autopicker/")
    oem("https://brightpick.ai/gridpicker/")
    oem("https://www.bluerivertechnology.com/")
    return 0
